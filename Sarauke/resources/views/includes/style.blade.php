...
<link rel="stylesheet" href="{{ url('OwlCarousel/dist/assets/owl.carousel.min.css') }}" />
<link rel="stylesheet" href="{{ url('OwlCarousel/dist/assets/owl.theme.default.min.css') }}" />
