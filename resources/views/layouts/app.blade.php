...
<body>
    ...
    @stack('addon-script')
    <!-- Logout Modal-->
    <div class="modal fade" id="needhelpModal" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel"
        aria-hidden="true">
        <div class="modal-dialog" role="document">
            <div class="modal-content">
                ...
                <div class="modal-body">You can contact us by clicking the button social media on the footer of this page.</div>
