@extends('layouts.app')
@section('title', 'Please Complete Your Payment')
                                ...
                                @if ($item->transaction_status == 'PENDING' && $item->bukti_pembayaran == '')
                                    <div class="alert alert-info mt-3">
                                        <p>
                                            ...
                                            <br>
                                        <form action="{{ route('kirimbukti') }}" method="POST"
                                        ...
                                        <button id="midtrans-btn" type="submit"
                                            class="btn btn-group-sm btn-success midtrans-btn">Kirim</button>
                                        </form>
                                    ...
                                    <div class="alert alert-info mt-3">
                                        <p>
                                            ...
                                            <a href="{{ asset('storage/' . $item->bukti_pembayaran) }}" target="_blank"
                                                class="btn btn-group-sm btn-primary mt-3">Lihat Bukti Pembayaran</a>
