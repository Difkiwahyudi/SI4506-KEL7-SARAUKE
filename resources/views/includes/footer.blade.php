<footer class="section-footer mt-5 border-top" style="background-color: #091426 !important;">
            ...
            <ul class="list-unstyled">
              ...
              <li><a href="#">support@nomads.id</a></li>
                ...
                <div class="row content justify-content-between">
                    <div
                        class="col-lg-4 col-sm-12 logo-wrapper flex-column align-items-center text-lg-start text-center align-items-lg-start">
                        <img height="70px" class="ms-lg-4 ps-lg-3" src="{{ asset('frontend/images/logo_.png') }}"
                            alt="">

                        <div class="d-flex social mt-4">
                            @if ($global_setting_data->facebook != '')
                                <a target="_blank" href="{{ $global_setting_data->facebook }}" title="Facebook"
                                    class="social-link">
                            ...
                            @if ($global_setting_data->twitter != '')
                                <a target="_blank" href="{{ $global_setting_data->twitter }}" title="Twitter"
                                    class="social-link">
                            ...
                            @if ($global_setting_data->instagram != '')
                                <a target="_blank" href="{{ $global_setting_data->instagram }}" title="Instagram"
                                    class="social-link">
                            ...
                            @if ($global_setting_data->youtube != '')
                                <a target="_blank" href="{{ $global_setting_data->youtube }}" title="Youtube"
                                    class="social-link">
                            ...
                            @if ($global_setting_data->pinterest != '')
                                <a target="_blank" href="{{ $global_setting_data->pinterest }}" title="Pinterest"
                                    class="social-link">
                            ...
                            @if ($global_setting_data->linkedin != '')
                                <a target="_blank" href="{{ $global_setting_data->linkedin }}" title="Linkedin"
                                    class="social-link">
                    ...
                    <div
                        class="col-lg-8 col-sm-12 flex-wrap text-center d-flex links justify-content-center justify-content-lg-end align-items-center footer-revamp-link">
